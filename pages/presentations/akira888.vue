...
export default {
  data: () => ({
    speaker: {
      ...
      abstract: '超絶技巧プログラミングやCreative Codingも楽しいけれど、普段の業務で書かれているロジックをうまく使ってあげるだけでも面白いことはいくらでもできます。すこしのひらめきとお手元の技術スタックを組み合わせれば、おやっと思わせるアート作品を作ることだってさほど難しくはありません。\nまたものづくりのためのコードも、課題解決のためのコードも本質的には同じものです。日々の業務スキルを活かし、磨き、学ぶことができます。今回はRails, Hotwire, HTML, CSSという馴染のある技術を用いて作成した、時計をモチーフにしたシンプルな動きが魅力的なアート作品を題材に、趣味のコーディングの楽しさやメリットなどについてのお話や、ちょっと踏み込んでWASMなどのWEBサーバーと異なる実行環境で実装したらどうなるかという実例をお見せしたいと思います。',
      type: 'basic',
      slide: 'https://speakerdeck.com/akira888/hutuunoji-shu-sutatukudeatozuo-pin-wozuo-tutemiru',
    },
  }),
}
</script>
